...
function _list() {    
   xhr.open("GET", "http://pascal.fis.agh.edu.pl/~antek/TI_2021/lab12/rest/list", true);   
...
function _insert(form)  {
    ...
    xhr.open("POST", "http://pascal.fis.agh.edu.pl/~antek/TI_2021/lab12/rest/save", true);
    xhr.addEventListener("load", e => {
       if ( xhr.status == 200 )    {
          document.getElementById('data').innerHTML = ''; 
...
function _delete(form) {
    ...
    xhr.open("DELETE", "http://pascal.fis.agh.edu.pl/~antek/TI_2021/lab12/rest/delete1/"+id_mongo, true);
    xhr.addEventListener( "load", e => {
       if (xhr.status  == 200 )    {
           document.getElementById('data').innerHTML = '';
           document.getElementById('result').innerHTML = JSON.stringify(xhr.response);
...
function _update(form) {
    ...
    user.year = form.year.value;
    txt = JSON.stringify(user);
    xhr.open("PUT", "http://pascal.fis.agh.edu.pl/~antek/TI_2021/lab12/rest/update1/"+id_mongo, true);
    xhr.addEventListener("load", e => {
         if ( xhr.status == 200 )    {
            document.getElementById('data').innerHTML = ''; 
            document.getElementById('result').innerHTML = JSON.stringify(xhr.response);
